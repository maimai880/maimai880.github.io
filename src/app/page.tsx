            ...
            <Block title="My works">
              <Flex justify="center" wrap="wrap" gap={8} w="full">
                ...
                >
                  ...
                  UIはTwitterを参考にデザインしたのですが、UI/UXについても考えられていいデザインになったと思います<br/>
                ...
                >
                  ...
                  デザインなどはMITライセンスのプロジェクトを真似させていただきました<br/>
                  かなり綺麗な出来になって満足しています<br/>
                  初めてのViteを使った開発でしたが、起動速度などが早くて捗りました<br/>
                ...
                >
                  ...
                  コードを渡して「何時間前とかが左下に表示されるようにして下さい」の様に指示を出すだけで実装出来たので、とても捗りました<br/>
                  今後はAIを上手く利用して開発を進めていきたいと強く思わされました<br/>
                  また、デプロイもしてみたのですが、Vercelが便利すぎて衝撃を受けました<br/>
                </WorkCard>
